    ...
    <Backdrop onClick={handleClose}>
      {type === 'dropIn' && (
        <motion.div
          ...
          className='flex flex-col justify-center bg-white rounded-xl dark:bg-[#1d2226] w-full max-w-lg md:-mt-96 mx-6'
          variants={dropIn}
          initial='hidden'
          animate='visible'
          exit='exit'
      ...
      {type === 'gifYouUp' && (
        <motion.div
          onClick={(e) => e.stopPropagation()}
          className='flex rounded-l-lg flex bg-[#1d2226] w-full max-w-6xl -mt-[7vh] mx-6'
          variants={gifYouUp}
          initial='hidden'
          animate='visible'
          exit='exit'
